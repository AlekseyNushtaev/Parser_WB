...
from markets.parser_avito import parser_avito
...
async def scheduler():
    while True:
        ...
        try:
            ...
            options_uc.add_argument('--user-agent=Mozilla/5.0 (iPhone; CPU iPhone OS 14_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0 Mobile/15E148 Safari/604.1')
        ...
        wait_time = max(datetime.timedelta(minutes=2) - elapsed, datetime.timedelta(0))  # Ждём оставшееся время
